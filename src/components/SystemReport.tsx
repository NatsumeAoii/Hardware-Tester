        ...
        <section className="rpt-container">
            ...
            <div className="rpt-paper">
                ...
                <footer className="rpt-footer">
                    <p>Generated by Hardware Diagnostic Suite &middot; {siteMeta.repositoryUrl}</p>
                </footer>
            </div>
            ...
            <style>{`
                ...
                .rpt-container { max-width: 900px; margin: 0 auto; padding-bottom: 4rem; min-width: 0; }
                .rpt-controls {
                    background: var(--surface-panel); border: 1px solid var(--border);
                    padding: 1.5rem; border-radius: var(--radius); margin-bottom: 1rem;
                    display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 1rem;
                }
                .rpt-actions { display: flex; gap: 1.5rem; align-items: center; min-width: 0; }
                .rpt-input-group { display: flex; align-items: center; gap: 0.5rem; min-width: 0; }
                ...
                .rpt-summary-bar {
                    ...
                    background: var(--surface-panel); border: 1px solid var(--border); margin-bottom: 1.5rem;
                }
                ...
                .rpt-paper {
                    background: white; color: black; padding: 2.5rem; max-width: 100%;
                ...
                .rpt-section h3 {
                    font-size: 1.1rem; text-transform: uppercase; letter-spacing: 0;
                ...
                @media (max-width: 600px) {
                    .rpt-container { max-width: 100%; padding-bottom: 2rem; }
                    .rpt-controls,
                    .rpt-actions,
                    .rpt-input-group,
                    .rpt-summary-bar,
                    .rpt-batch-actions {
                        width: 100%; flex-direction: column; align-items: stretch; gap: 0.75rem; margin-left: 0;
                    }
                    .rpt-controls { padding: 1rem; }
                    .rpt-controls header { min-width: 0; }
                    .rpt-controls h2, .rpt-controls p { overflow-wrap: anywhere; }
                    .rpt-input-group input { width: 100%; }
                    .rpt-summary-bar { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); }
                    .rpt-batch-actions { grid-column: 1 / -1; display: grid; grid-template-columns: 1fr; }
                    .btn-sm { min-height: 44px; }

                    .rpt-paper { padding: 1rem; overflow: hidden; }
                    .rpt-header { flex-direction: column; gap: 1rem; }
                    .rpt-title h1 { font-size: 1.25rem; overflow-wrap: anywhere; }
                    .rpt-meta p, .rpt-footer p { overflow-wrap: anywhere; }

                    .rpt-specs-table,
                    .rpt-specs-table tbody,
                    .rpt-specs-table tr,
                    .rpt-specs-table th,
                    .rpt-specs-table td {
                        display: block; width: 100%;
                    }
                    .rpt-specs-table tr { padding: 0.35rem 0; border-bottom: 1px solid #eee; }
                    .rpt-specs-table th,
                    .rpt-specs-table td { border-bottom: 0; padding: 0.18rem 0; overflow-wrap: anywhere; }

                    .rpt-results-grid { gap: 1rem; }
                    .rpt-results-table { table-layout: fixed; font-size: 0.78rem; }
                    .rpt-results-table th,
                    .rpt-results-table td { padding: 0.35rem; overflow-wrap: anywhere; }
                    .rpt-results-table th:nth-child(1),
                    .rpt-results-table td:nth-child(1) { width: 38%; }
                    .rpt-results-table th:nth-child(2),
                    .rpt-results-table td:nth-child(2) { width: 28%; }
                    .rpt-results-table th:nth-child(3),
                    .rpt-results-table td:nth-child(3) { width: 34%; }
                    .rpt-test-actions { justify-content: flex-start; flex-wrap: wrap; }
                    .rpt-btn-status { width: 44px; height: 44px; }
                }
